...
.. Grund: wird (aktuell) für Google API benötigt
...
. Eingabelogik
* +++<u>Zustand</u>+++:
* +++<u>Zweck</u>+++: Spezifiziert und prüft nach Korrektheit von Eingaben
* +++<u>Eigenschaften</u>+++:
* +++<u>Funktion</u>+++:
. Persistenz
* +++<u>Zustand</u>+++:
* +++<u>Zweck</u>+++: Art der Datenspeicherung
* +++<u>Eigenschaften</u>+++: sinnvoll, verlustsicher
* +++<u>Funktion</u>+++:
. Zugriffsschutz
* +++<u>Zustand</u>+++:
* +++<u>Zweck</u>+++: 
** Prüfen von Zeige-/Bearbeitungsrechten
** Verhindern von Hacking über Formularfelder(z.B. Injection)
* +++<u>Eigenschaften</u>+++:
* +++<u>Funktion</u>+++:
. Verschlüsselung
* +++<u>Zustand</u>+++:
...
** *Methoden:*
*** +++<u>zeigenKalender</u>+++: Anzeigen von gewählten Kalender
*** +++<u>aktualisierenKalender</u>+++: Kalender wird über API neu geladen
*** +++<u>bearbeitenNotizfeld</u>+++: Nutzer kann in Formular Notizfeld bearbeiten
*** +++<u>hinzufügenEintrag/e</u>+++: automatische Erstellung bei Datenübergabe von make/save conference site
*** +++<u>suchenEintrag/e</u>+++:  Suche über Eingabefeld und Anzeige durch Entfernen unrelevanter Einträge im Kalender bzw. nach dem Prinzip von Strg+F
*** +++<u>löschenEintrag/e</u>+++: Löschen eines Eintrages durch Nutzer
