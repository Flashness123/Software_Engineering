...
//xref:use-case_model.adoc#Allgemeine Informationen[Use-Case Model]
<<Use-Case Model: E1 Kalenderintegration, Use-Case Model>>
//link:use-case_model.adoc#[Section B]
