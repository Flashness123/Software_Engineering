...
1. Der Use Case beginnt, wenn der Benutzer in der Navigationsleiste auf den "Login"-Button klickt.
2. Das System zeigt die Anmeldeseite an, auf der der Benutzer seine E-Mail-Adresse und sein Passwort eingeben kann.
3. Der Benutzer gibt seine Daten ein und klickt auf den "Sign In"-Button.
4. Use Case: Benutzer validieren wird durchgeführt.
5. Das System zeigt die relevante Hauptseite an.
...
1. Die Meldung "Ungültige E-Mail oder ungültiges Passwort - bitte versuchen Sie es erneut" wird angezeigt.
2. Der Anwendungsfall wird bei Schritt 3 fortgesetzt.
