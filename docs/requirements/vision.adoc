= Vision: {project-name}
Marc-Oliver Tittel <s82452@htw-dresden.de>; Manuel Hartmann <s83688@htw-dresden.de>; Charlotte Geißler <s82397@htw-dresden.de>; Jan Trodler <s83832@htw-dresden.de>; Lukas Kouba <s00000@htw-dresden.de>; Luc Sowodniok <s83864@htw-dresden.de>; Luc Sowodniok <s00000@htw-dresden.de>
{localdatetime}
...
Das StartUp SpeechMind ermöglicht eine schriftliche Meetingdokumentation auf Tonaufnahmen. Nun ist von SpeechMind der Auftrag eine Kalenderintegration als Webanwendung zu programmieren. Diese soll es ermöglichen auf den Google, Outlook o.Ä. Kalender des Nutzers zuzugreifen und den Link zu der Dokumentation durch einen einfachen Klick den Verweis zu der Dokumentation hinzuzufügen. 
