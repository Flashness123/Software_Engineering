...
| betrifft | Auftraggeber, Nutzer von SpeechMind, Gesetzgeber, Projektteam, Nodejs Server
...
. Die Nutzungszeit kann sich von Nutzer zu Nutzer, je nach Umfang des Meetings und Bearbeitung, ändern. 
...
| Nachbearbeiten der Notizfelder des Kalendereinträge | hoch | nachträgliche Ergänzung von Informationen | xx
|===
